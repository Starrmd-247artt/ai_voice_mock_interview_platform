  ...
  return (
   <div className='p-5 bg-black rounded-xl'>
      ...
      <div>
        ...
        <Textarea placeholder="Enter details job description" className='h-50 mt-2'
      ...
      <div>
        ...
        <div className='flex gap-3 flex-wrap mt-2'>
           {InterviewType.map((type,index)=>(
            <div key={index} className={`flex items-center cursor-pointer gap-2 p-1 px-2 mt-5 bg-black border border-gray-300 rounded-2xl 
            hover:bg-secondary
